...
In this project I was given a web-based application that reads RSS feeds, and
was instructed to write a few test suites with Jasmine.

## Usage

You may visit `index.html` at the
[github project page](http://www.nikosath.net/udacity-frontend-nanodegree-feedreader/).
